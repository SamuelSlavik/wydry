...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(3,'auth','group'),(2,'auth','permission'),(4,'contenttypes','contenttype'),(7,'information','information'),(5,'sessions','session'),(6,'userauth','user');
...
INSERT INTO `information_information` VALUES (1,'Lorem ipsum dolor sit amet, consectetur adipiscing elit.','Nullam pharetra at risus ut pretium. Quisque pharetra finibus porta. Donec placerat orci eget neque placerat, at rhoncus ligula mattis. Morbi eu lacus eu enim pellentesque sollicitudin fermentum ac magna. Pellentesque faucibus, nunc vel dictum consectetur, dolor risus hendrerit libero, ac tristique magna turpis eu nulla. Quisque eu convallis arcu, at suscipit sem. Praesent volutpat hendrerit orci sed cursus. Aenean viverra enim mi, id tincidunt neque tincidunt a. Duis fermentum pharetra nibh id tristique. Cras venenatis eros et massa rhoncus ornare. In leo lorem, suscipit tincidunt felis placerat, egestas imperdiet dolor. Etiam ut viverra quam, non sagittis augue. Phasellus dignissim id eros bibendum pretium.',NULL,'2022-07-27','2022-10-06'),(2,'Phasellus tincidunt vel diam quis maximus.','Mauris nisi nunc, ullamcorper et erat sit amet, vehicula mollis lectus. Aenean pretium nunc a neque sodales, quis auctor massa feugiat. Nunc dignissim enim sed sodales tincidunt. Suspendisse finibus, nunc vitae porttitor luctus, mi tellus ultrices nunc, eu feugiat ligula arcu vel arcu. Integer ut lectus quis felis accumsan mollis non quis justo. Suspendisse congue nibh et ipsum accumsan congue. Curabitur accumsan risus sed feugiat iaculis. Ut luctus nunc et nulla aliquet lobortis. Aliquam ligula metus, auctor id urna sed, convallis sagittis nunc. Nam aliquam justo at purus iaculis, a volutpat elit mollis.','Lorem Ipsum','2022-07-27',NULL),(3,'Vestibulum consectetur dapibus est quis mattis.','Suspendisse nec aliquet purus. Donec diam diam, laoreet sed ligula sit amet, vehicula mollis justo. Sed sit amet arcu nec urna venenatis imperdiet in eget dui. Suspendisse sed justo ut lacus semper accumsan ut ac elit. Pellentesque congue non libero nec porttitor. Phasellus fermentum, elit ut congue cursus, est ipsum malesuada lorem, at euismod justo felis a felis.','Admin','2022-07-27','2022-07-27');
...
INSERT INTO `userauth_user` VALUES ('pbkdf2_sha256$260000$kxE3113HKlo14JHfcfJY0x$fWcdu1l/T3/HNI70OjjlTdQpKNx6WJ7DIwydGH/d3ZU=','2022-07-27 13:53:40.888692',1,'',1,1,'2022-07-27 13:53:29.271578',1,'root',NULL,NULL,'2022-07-27');
...
-- Dump completed on 2022-07-27 16:38:11
